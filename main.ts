...
//require('./node_modules/console-panel/src/console-panel.js')
//import * as css from './node_modules/console-panel/src/console-panel.css'
...
export default class ObsidianDevTools extends Plugin {
  ...
  async onload() {
    ...
    */
	...
	console.log(window.consolePanel)
